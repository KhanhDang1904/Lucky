...
//    }
    ...
    public function behaviors()
    {
        ...
        $this->auth = isset($auth[1]) ? $auth[1] : null;
        \Yii::$app->response->format = Response::FORMAT_JSON;
//        throw new HttpException(500,json_encode($_POST));
        $user = User::findOne([
            'auth_key' => $this->auth,
            'status' => 10,
        ]);
    ...
    public function sendEMail($senderName, $senderEmail, $toEmail, $toName, $subject, $htmlContent)
    {
        ...
        curl_setopt_array($curl, array(
            ...
            CURLOPT_HTTPHEADER => array(
                ...
                'api-key: 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',
    ...
    public function outputSuccess($data = "",$config= [], $mes = "")
    {
        return [
            'status' => true,
            'code' => 200,
...
//        VarDumper::dump('http://rest.esms.vn/MainService.svc/json/SendMultipleMessage_V4_get?Phone=' . $phone . '&Content=' . $content . '&ApiKey=41E4EA36160CD85E4F5F8A7A1C9B64&SecretKey=13AFA24E0C26C764B7593299FB3869&IsUnicode=1&Brandname=TrongtrePro&SmsType=2&CallbackUrl=&RequestId=');exit();
    ...
    public function makeString($originalString,$number = 4)
    {
        return substr_replace($originalString, str_repeat("*", strlen($originalString) - $number), $number);
    }
}
